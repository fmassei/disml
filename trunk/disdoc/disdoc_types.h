...
*/
#ifndef H_DISDOC_TYPES_H
#define H_DISDOC_TYPES_H

#include <disml.h>

typedef struct document_s {
    char *title, *subtitle, *author1, *author1mail, *url;
    t_mmp_list_s *section;
} t_document_s;

typedef struct section_s {
    char *title, *text, *type;
    t_mmp_list_s *section;
} t_section_s;

#endif /* H_DISDOC_TYPES_H */
